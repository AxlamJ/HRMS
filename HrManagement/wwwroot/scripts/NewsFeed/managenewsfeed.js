								...
								<div class="mb-6">
                                    <div class="row">
                                        <div class="d-flex justify-content-center text-end gap-2">
                                            ...
                                            <a href="${sitePath}NewsFeed/NewsFeedForm?Id=${feed.Id}" class="btn btn-primary btn-lg btnedit" id="btnedit" data-id="${feed.Id}">
                                                <i class="fa fa-pencil me-1"></i>Edit
                                            </a>
                                            <span class="btn btn-danger btn-lg btndelete" id="btndelete" data-id="${feed.Id}">
...
$(document).on("click", ".btndelete", function () {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            Ajax.post(sitePath + "api/NewsFeedAPI/DeleteNewsbyId?Id=" + Id, null, function (resp) {
