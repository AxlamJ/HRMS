...
$("#btn-add-cert").on("click", function () {
    ...
    if (!errors) {
        ...
        certificate.EmployeeCode = parseInt(_EmployeeData.EmployeeCode);
...
$(document).on("click", "#nav-license-tab", function () {
    ...
    var url = sitePath + "api/EmployeeAPI/GetCertByEmpCode?EmployeeCode=" + parseInt(_EmployeeData.EmployeeCode);
