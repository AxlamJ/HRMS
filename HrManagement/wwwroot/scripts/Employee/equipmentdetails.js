...
$("#btn-add-equipment-details").on("click", function () {
    ...
    if (!errors) {
        ...
        equipment.EmployeeCode = parseInt(EmployeeData.EmployeeCode);
...
$(document).on("click", "#nav-equipment-tab", function () {
    ...
    var url = sitePath + "api/EmployeeAPI/GetEquipmentByEmpCode?EmployeeCode=" + parseInt(EmployeeData.EmployeeCode);
