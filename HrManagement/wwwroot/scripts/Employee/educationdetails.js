...
$("#btn-update-education-details").on("click", function () {
    ...
    if (!errors) {
        ...
        education.EmployeeCode = parseInt(EmployeeData.EmployeeCode);
...
$(document).on("click", "#nav-education-tab", function () {
    ...
    var url = sitePath + "api/EmployeeAPI/GetEmployeeEducationDetails?EmployeeCode=" + parseInt(EmployeeData.EmployeeCode);
